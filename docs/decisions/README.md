...
- [ADR-013](ADR-013-delete-the-conductor.md) — delete the conductor: it never produced a ledger event, and the clustering it named already ships as batch co-location; supersedes ADR-012's "collapse it into the one path"
