...
export const CITATION_CLAIMS: CitationClaim[] = [
  ...
  { id: 'clusterByTouches', file: 'conductor', mustContain: 'export function clusterByTouches' },
  { id: 'conductorWorktreeHead', file: 'conductor', mustContain: 'openBuildWorktree(plan.repoPath' },
  { id: 'conductorClaimItems', file: 'conductor', mustContain: 'await claimItems(opts.ledgerDir, {' },
